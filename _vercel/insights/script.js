    ...
    (t = ()=>{
        ...
        function() {
            let t = {}
              ...
              , l = null
              , s = !0;
            async function u({type: o, data: s, options: u}) {
                var d, c, p;
                let f = e(l)
                  , h = document.referrer
                  , v = n({
            ...
            let v = e()
              , w = ()=>{
                ...
                window.va = function(e, a) {
                    "beforeSend" === e ? n = a : "setProps" === e ? Object.assign(t, a) : "event" === e ? a && c(a.name, a.data, a.options) : "pageview" === e && a && (a.route && (r = a.route),
                    a.path && (l = a.path),
                    d({
                        withReferrer: s
                    }),
